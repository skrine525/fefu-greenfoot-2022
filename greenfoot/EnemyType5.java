...
public class EnemyType5 extends EnemyBasic
{
    ...
    private GreenfootImage[] hitImages;

    // Константы
    private static int IMAGE_COUNT = 2;                     // Количество других изображений
    ...
    // Переопределяем для другой логики нанесения урона
    @Override
    public void Hit()
    {
        hitpoints--;
        ...
        else
        {
            ...
            Meds meds = new Meds();
            gameplay.addObject(meds, getX(), getY());
    ...
    {
        hitImages = new GreenfootImage[IMAGE_COUNT];
        for(int i = 0; i < IMAGE_COUNT; i++)
        {
            hitImages[i] = new GreenfootImage("EnemyType5/Hit" + (i) + ".png");
        }
    }
}
